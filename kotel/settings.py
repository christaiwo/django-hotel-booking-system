...
SECRET_KEY = 'django-insecure-=%)*%(xo#h7-_!dpelmi_=btsh^uy64e+_x4$798mbe_b4*=6*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://christaiwo-kotel.herokuapp.com/', 'christaiwo-kotel.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'kotel.wsgi.application'
